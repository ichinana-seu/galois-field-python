...
if __name__ == "__main__":
    ...
    for ComplexSNR_dB in Eval_ComplexSNR_dB_set: 
        ...
        while error_blocks_now < 50:
            ...
            hardout_bins, failflag = zhx_RS_EuclidDecoder_torchBatch.zhx_RS_EuclidDecoder_inputBins_torchBatch(received_hardDecision, RS_t, myGF2map, device, multithread)
            # 统计BER
